...
const WeddingTriosRingScreen = memo((props) => {
  ...
  return (
    <Layout title="Wedding Trios Rings">
      <Breadcrumbs
        title="Свадебные трио"
        path="/wedding-trios-rings"
            ...
            <div className="grid grid-cols-2 gap-5 mb-5">
              <div className="flex flex-col">
                ...
                <select
                  ...
                  onChange={(e) => setSizeRingWoman(Number(e.target.value))}
                >
                  <option value="">---</option>
              ...
              <div className="flex flex-col">
                ...
                <select
                  className="w-1/2 sm:w-1/4 md:w-2/3 lg:w-1/2 xl:w-2/5 text-sm lg:text-base text-center text-gray-400"
                  name="man size ring"
                  onChange={(e) => setSizeRingMan(Number(e.target.value))}
                >
                  <option value="">---</option>
                  <option value="14.00">14.00</option>
                  <option value="14.25">14.25</option>
...
WeddingTriosRingScreen.displayName = 'WeddingTriosRingScreen';
export default WeddingTriosRingScreen;
...
WeddingTriosRingScreen.propsTypes = {
...
WeddingTriosRingScreen.defaultTypes = {
  reviews: PropTypes.arrayOf(
    PropTypes.shape({
      bind: '',
      name: '',
