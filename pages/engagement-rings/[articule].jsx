...
const EngagementRingScreen = memo((props) => {
  ...
  const addToCartHandler = async () => {
    ...
    if (sizeRingWoman) {
      dispatch({
        type: 'CART_ADD_ITEM',
        payload: { ...ring, quantity, sizeRingWoman },
      });
      router.push('/cart');
    } else {
...
EngagementRingScreen.displayName = 'EngagementRingScreen';
export default EngagementRingScreen;
...
EngagementRingScreen.propsTypes = {
...
EngagementRingScreen.defaultTypes = {
  reviews: PropTypes.arrayOf(
    PropTypes.shape({
      bind: '',
      name: '',
